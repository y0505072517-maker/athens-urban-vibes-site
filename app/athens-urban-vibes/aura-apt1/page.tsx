...
const APT = {
  ...
  description: `A light-filled, modern loft in the heart of Athens — steps from the metro and surrounded by the city's best cafés and restaurants. The standout feature: your own private patio, a rare urban oasis with natural greenery and ambient lighting. Renovated to a high standard with natural wood finishes, premium queen bed, full kitchen and fast Wi-Fi. Perfect for couples, solo travellers and small groups who want comfort, style and a real Athens experience.`,
  guests: 4,
  beds: 1,
  baths: 1,
  sleeps: "1 Queen Bed",
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {APT.images.map((src, i) => (
            <div key={i} onClick={() => openLightbox(src)} className="relative aspect-[4/3] rounded-xl overflow-hidden bg-zinc-900 cursor-pointer group border border-zinc-800 hover:border-[#D4AF37]/50 transition-all">
              <Image src={src} alt={`${APT.name} photo ${i + 1}`} fill className="object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-14 border-t border-zinc-800 pt-10">
            ...
            <div className="grid grid-cols-2 gap-4 text-zinc-400 text-sm">
              <div>🔑 Self check-in with smart lock</div>
