...
export default function ApartmentTwo() {
  const images = ["/miron18/apt2/cover.jpg", "/miron18/apt2/img1.jpg", "/miron18/apt2/img2.jpg", "/miron18/apt2/img3.jpg", "/miron18/apt2/img4.jpg", "/miron18/apt2/img5.jpg", "/miron18/apt2/img6.jpg"];
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] text-white font-sans text-left">
      <nav className="p-6 border-b border-white/10 flex justify-between items-center text-[10px] uppercase tracking-widest sticky top-0 bg-[#1A1A1A]/90 backdrop-blur-sm z-50">
        ...
        <span className="text-blue-400 font-bold uppercase tracking-widest italic">Aura No.2</span>
      </nav>

      <main className="max-w-6xl mx-auto px-6 py-12">
        <header className="mb-12 text-center md:text-left">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase mb-4 leading-none text-white">Aura <span className="text-blue-400 block">Apartment 2</span></h1>
          <p className="text-gray-400 uppercase tracking-widest text-[10px] italic">7 Minutes from Metro • Backyard Bliss Patio • Fully Renovated</p>
        </header>

        {/* גלריית תמונות */}
        <div className="space-y-4 mb-24">
          <div className="aspect-video overflow-hidden rounded-lg border border-white/10 shadow-2xl">
            <img src={images[0]} className="w-full h-full object-cover opacity-95" alt="Aura 2 Main" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 border-t border-white/5 pt-16 items-start">
          <div className="md:col-span-2 space-y-12">
            <section>
                ...
                <p className="text-xl text-gray-300 leading-relaxed italic">"Find your peace in our Backyard Bliss. This ground-floor sanctuary features a private patio, blending urban living with a touch of nature, all designed to make you smile."</p>
            </section>
            ...
            <section>
                ...
                <div className="grid grid-cols-2 gap-y-8 gap-x-4">
                    ...
                    <div className="flex items-center gap-3"><span className="text-blue-400 text-xl">🌳</span> <span className="text-xs uppercase tracking-widest">Private Patio</span></div>
                </div>
            </section>
          </div>
          ...
          <div className="sticky top-28 bg-white/5 p-8 rounded-xl border border-white/10 text-center shadow-2xl backdrop-blur-md">
            ...
            <div className="space-y-4">
              <a href="https://www.booking.com/hotel/gr/athens-urban-vibes-2-backyard-bliss-patio.he.html" target="_blank" className="block w-full bg-[#003580] text-white py-4 rounded font-bold uppercase text-[11px] tracking-widest no-underline hover:opacity-90 transition-all">
                Reserve on Booking.com
              </a>
              <a href="https://he.airbnb.com/rooms/1457082891737996951" target="_blank" className="block w-full bg-[#FF5A5F] text-white py-4 rounded font-bold uppercase text-[11px] tracking-widest no-underline hover:opacity-90 transition-all">
                Book on Airbnb
              </a>
            </div>
