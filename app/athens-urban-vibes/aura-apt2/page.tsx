...
const APT = {
  ...
  subtitle: "PRIVATE GARDEN PATIO · ROMANTIC STUDIO · FULLY RENOVATED",
  description: `Your own private garden in the middle of Athens. Glass doors open directly onto a secluded patio with artificial grass and LED lighting — ideal for morning coffee, evening wine or a romantic dinner under the stars. Inside: minimalist design with black metal accents and natural wood, espresso machine, full kitchen and a quiet queen bed with premium linen. A rare find in the city.`,
  guests: 4,
  beds: 2,
  baths: 1,
  sleeps: "1 Double Bed + Sofa",
  bookingUrl: "https://www.booking.com/hotel/gr/athens-urban-vibes-2-backyard-bliss-patio.he.html",
  airbnbUrl: "https://he.airbnb.com/rooms/1457082891737996951",
  amenities: [
    { icon: "🌿", label: "Private Garden" },
    { icon: "☕", label: "Espresso Machine" },
  ...
  images: [
    '/miron18/apt2/img1.jpg',
    '/miron18/apt2/img2.jpg',
    '/miron18/apt2/img3.jpg',
    '/miron18/apt2/img4.jpg',
    '/miron18/apt2/img5.jpg',
    '/miron18/apt2/img6.jpg',
  ],
};

export default function AuraApt2Page() {
