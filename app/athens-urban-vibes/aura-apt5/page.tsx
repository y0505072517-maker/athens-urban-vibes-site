...
const APT = {
  ...
  subtitle: "PRIVATE BALCONY · ORTHOPEDIC QUEEN BED · MINIMALIST DESIGN",
  ...
  beds: 1,
  baths: 1,
  sleeps: "1 Queen Bed (Orthopedic)",
  bookingUrl: "https://www.booking.com/hotel/gr/athens-urban-vibes-5-cozy-balcony-renovated.he.html",
  airbnbUrl: "https://he.airbnb.com/rooms/1457142085700844192",
  amenities: [
    { icon: "🌇", label: "Private Balcony" },
    { icon: "🛏", label: "Orthopedic Bed" },
  ...
  images: [
    '/miron18/apt5/img1.jpg',
    '/miron18/apt5/img2.jpg',
    '/miron18/apt5/img3.jpg',
    '/miron18/apt5/img4.jpg',
    '/miron18/apt5/img5.jpg',
    '/miron18/apt5/img6.jpg',
  ],
};

export default function AuraApt5Page() {
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-14 border-t border-zinc-800 pt-10">
            ...
            <div className="grid grid-cols-2 gap-4 text-zinc-400 text-sm">
              ...
              <div>🧳 Long stays welcome (28+ days)</div>
            </div>
          </div>
        </div>
